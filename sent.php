...
#submit-subscribe{
   ...
   float: right;margin-top:-38px;margin-right:20%;  color: white;border-radius:0px 15px 15px 0px; 
}
...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'Tokyo')" id="defaultOpen"><a style='color:black;text-decoration:none;' onClick='history.go(-1)'>Sent</a></button>
</div>
...
<div id="wrap">
 ...
 <div class="sender" style=" ">To:&nbsp; <?php echo$username; ?>&nbsp;&nbsp;&nbsp;&nbsp;</div><br>   
...
<span id="date">Sent: <?php echo$time_ago ;?></span>

<a class="btn-danger" href='remove-sent.php?id=<?php echo$id?>'><i class='fa fa-trash'></i></a>
