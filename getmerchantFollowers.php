...
if (isset($_GET['id'])) {
  ...
  $getFollowers = mysqli_query($conn,"select * from profile where id ='$id'");

  while ($row = mysqli_fetch_array($getFollowers)) {
...
echo "<a href='merchant.php?id=$myid'><img class='imgProfile' style='background-color:rgba(0,0,0,0.3);'></a>";
...
?>
 ...
 <?php
  ...
  echo "<div style='color:red;' align='center'><br><br><br>This merchant has no follower yet<br><br><br></div>";
}
...
<p align="center" style="color: white;font-weight:600' font-family:'Montserrat',sans-serif;font-size:14px;">Sign up for our newsletter</p>
<div class="container">
...
<div style ='line-height:23px' class="col-md-3 col-6 col-sm-3">
...
if(response==1){
            ...
            swal({
                ...
                icon:"success",text:"Thanks for subscribing"
